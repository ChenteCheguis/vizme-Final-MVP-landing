...
-- IMPORTANTE: SET search_path = public es obligatorio. Sin esto, el trigger se
-- ejecuta con el search_path del schema auth y no encuentra public.profiles,
-- causando "Database error creating new user" desde admin.createUser.
